...
(* val ingresar_libro = fn : libro arbolbin * string * string -> libro arbolbin *)
fun ingresar_libro(Vacio: libro arbolbin, tit:string, aut:string) = …………………………………………………………………………
...
fun libros_prestados(registro: libro arbolbin) = 
	let 
		val l=convertir_arbol_a_lista(registro)
	in
		filter ……………………… l
	end;
...
fun cantidad_disponibles(registro: libro arbolbin) =  
	let
		val lista= convertir_arbol_a_lista(registro);
		val disponibles= filter ……………………… lista
	in
